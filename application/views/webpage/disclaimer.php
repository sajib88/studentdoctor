    ...
    <div class="container career-inner">
        ...
        <div class="row">
            <div itemprop="articleBody">
                <h1><i class="ti-layout-menu"></i>Disclaimer</h1>
                <hr class="hr-class">
...
<p>&nbsp;</p>
<div class="innerText">When ordering or registering on our site, as appropriate, you may be asked to enter your name, email address, mailing address, doctor profession or other details to help you with your experience.</div>
<p>&nbsp;</p>
...
<div class="innerText">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="Apple-converted-space">&nbsp;</span><strong>•</strong><span class="Apple-converted-space">&nbsp;</span>To personalize your experience and to allow us to deliver the type of content and product offerings in which you are most interested.</div>
<div class="innerText">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="Apple-converted-space">&nbsp;</span><strong>•</strong><span class="Apple-converted-space">&nbsp;</span>To improve our website in order to better serve you.</div>
<div class="innerText">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="Apple-converted-space">&nbsp;</span><strong>•</strong><span class="Apple-converted-space">&nbsp;</span>To allow us to better service you in responding to your customer service requests.</div>
<div class="innerText">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="Apple-converted-space">&nbsp;</span><strong>•</strong><span class="Apple-converted-space">&nbsp;</span>To administer a contest, promotion, survey or other site feature.</div>
<p>&nbsp;</p>
...
<div class="innerText">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="Apple-converted-space">&nbsp;</span><strong>•</strong><span class="Apple-converted-space">&nbsp;</span>Help remember and process the items in the shopping cart.</div>
<div class="innerText">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="Apple-converted-space">&nbsp;</span><strong>•</strong><span class="Apple-converted-space">&nbsp;</span>Keep track of advertisements.</div>
...
<p>&nbsp;</p>
<div class="innerText">Google's advertising requirements can be summed up by Google's Advertising Principles. They are put in place to provide a positive experience for users. https://support.google.com/adwordspolicy/answer/1316548?hl=en<span class="Apple-converted-space">&nbsp;</span><br><br></div>
...
<div class="innerText">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="Apple-converted-space">&nbsp;</span><strong>•</strong><span class="Apple-converted-space">&nbsp;</span>Google Display Network Impression Reporting</div>
<div class="innerText">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="Apple-converted-space">&nbsp;</span><strong>•</strong><span class="Apple-converted-space">&nbsp;</span>Demographics and Interests Reporting</div>
<p>&nbsp;</p>
...
<p><strong><strong><strong><span id="calOppa"></span><br></strong></strong></strong></p>
...
<div class="innerText">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="Apple-converted-space">&nbsp;</span><strong>•</strong><span class="Apple-converted-space">&nbsp;</span>Via Email</div>
<div class="innerText">Can change your personal information:</div>
<div class="innerText">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="Apple-converted-space">&nbsp;</span><strong>•</strong><span class="Apple-converted-space">&nbsp;</span>By emailing us</div>
<div class="innerText">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="Apple-converted-space">&nbsp;</span><strong>•</strong><span class="Apple-converted-space">&nbsp;</span>By calling us</div>
<div class="innerText">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="Apple-converted-space">&nbsp;</span><strong>•</strong><span class="Apple-converted-space">&nbsp;</span>By logging in to your account</div>
<div class="innerText">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="Apple-converted-space">&nbsp;</span><strong>•</strong><span class="Apple-converted-space">&nbsp;</span>By chatting with us or by sending us a support ticket</div>
...
<p><strong><strong><strong><span id="coppAct"></span><br></strong></strong></strong></p>
...
<p><strong><strong><strong><span id="ftcFip"></span><br></strong></strong></strong></p>
...
<div class="innerText">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="Apple-converted-space">&nbsp;</span><strong>•</strong><span class="Apple-converted-space">&nbsp;</span>Within 7 business days</div>
...
<p><strong><strong><strong><span id="canSpam"></span><br></strong></strong></strong></p>
...
<div class="innerText">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="Apple-converted-space">&nbsp;</span><strong>•</strong><span class="Apple-converted-space">&nbsp;</span>Send information, respond to inquiries, and/or other requests or questions</div>
<div class="innerText"><br><strong>To be in accordance with CANSPAM, we agree to the following:</strong></div>
<div class="innerText">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="Apple-converted-space">&nbsp;</span><strong>•</strong><span class="Apple-converted-space">&nbsp;</span>Not use false or misleading subjects or email addresses.</div>
<div class="innerText">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="Apple-converted-space">&nbsp;</span><strong>•</strong><span class="Apple-converted-space">&nbsp;</span>Identify the message as an advertisement in some reasonable way.</div>
<div class="innerText">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="Apple-converted-space">&nbsp;</span><strong>•</strong><span class="Apple-converted-space">&nbsp;</span>Include the physical address of our business or site headquarters.</div>
<div class="innerText">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="Apple-converted-space">&nbsp;</span><strong>•</strong><span class="Apple-converted-space">&nbsp;</span>Monitor third-party email marketing services for compliance, if one is used.</div>
<div class="innerText">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="Apple-converted-space">&nbsp;</span><strong>•</strong><span class="Apple-converted-space">&nbsp;</span>Honor opt-out/unsubscribe requests quickly.</div>
<div class="innerText">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="Apple-converted-space">&nbsp;</span><strong>•</strong><span class="Apple-converted-space">&nbsp;</span>Allow users to unsubscribe by using the link at the bottom of each email.</div>
...
<p><strong><strong><strong><br><span id="ourCon"></span><br></strong></strong></strong></p>
...
<div class="innerText">foralldoctors.com</div>
<p><strong><strong><strong>Florida, Florida 34110</strong></strong></strong></p>
