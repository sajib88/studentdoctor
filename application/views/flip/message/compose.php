...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="row">
            ...
            <div class="col-md-9">
                <form role="form" method="post" id="message_form" enctype="multipart/form-data" action="<?php echo base_url('FlipMessage/compose'); ?>">
...
<script>
    function getComboA(sel) {
        ...
        $.ajax({
            type: 'POST',
            url: base_url + "flip/FlipMessage/getProfessionByAjax",
            data: da,
            dataType: "text",
