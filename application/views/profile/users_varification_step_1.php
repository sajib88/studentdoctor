...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="row">
            ...
            <form role="form" method="post" id="website" enctype="multipart/form-data" action="<?php echo base_url('profile/Profile/user_varify_1'); ?>">
                <div class="col-md-6">
                        ...
                        <div class="box box-primary">
                            ...
                            <div class="padd">
                                <div class="form-group">
                                    ...
                                    <input type="hidden" name="user_level" value="<?php echo $user_info['user_level']; ?>" class="form-control">
                                </div>
                                <div class="form-group">
                                    <label>Email</label>
                        ...
                        <div class="box box-primary">
                            ...
                            <div class="padd">
                                ...
                                <div class="callout callout-success">
                                    <h4><i class="icon fa fa-check"></i> Access Level </h4>
                                    <p>All Access except Messaging , Patient dealing / Personals</p>
                                </div>
                            </div>
                        </div>
                    </div>
