...
<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            <h3 class="page-header">Blog Category Manage </h3>
        </div>
    </div>
    <div class="row">
            ...
            <div class="panel with-nav-tabs panel-default">
                <div class="panel-heading">
                    <ul class="nav nav-tabs">
                        <li class="active"><a href="#tab1default" data-toggle="tab">Pending Blog Category</a></li>
                        <li><a href="#tab2default" data-toggle="tab">Active Blog Category</a></li>
                                ...
                                <div id="no-more-tables">
                                    ...
                                    <table class="table table-hover" id="js_personal_table">
                                        ...
                                        ?>
                                                    ...
                                                    <td data-title="<?php echo 'action'; ?>" class="numeric"> <a href="<?php echo base_url('admin/Category/eventupdate') . '/' . $row->id . '/' . $row->status .'/insideblog_cat'; ?>">
                                                            <?php
                                                            if ($row->status == 1) {
