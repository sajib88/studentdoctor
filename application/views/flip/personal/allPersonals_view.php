                                ...
                                <?php if(!empty($allpersonals)) {
                                    ...
                                    foreach ($allpersonals as $row) { ?>
                                        <tr>
                                            ...
                                            <td data-title="<?php echo 'Edit'; ?>" class="numeric"><a href="<?php echo base_url('flippersonal/edit/' . $row->id); ?>" class="btn btn-block btn-primary"> Edit</a></td>
                                            <td data-title="<?php echo 'Detail'; ?>" class="numeric"><a href="<?php echo base_url('flippersonal/detail/' . $row->id); ?>" class="btn btn-block btn-success"> View</a></td>
                                            <td data-title="<?php echo 'Remove'; ?>" class="numeric"><a href="<?php echo base_url('flippersonal/Personal/delete/' . $row->id); ?>" class="btn btn-block btn-danger">Remove</a></td>
                                        </tr>
                                        <?php $i++;
                                    }
                                }?>
