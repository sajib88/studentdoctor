            ...
            <div class="col-lg-6">
                <div class="box box-primary">
                    <div class="panel-body">
                            <form role="form" method="post" id="personalform" enctype="multipart/form-data" action="<?php echo base_url('FlipGroup/search'); ?>">
                                <div class="col-lg-12">
                                                        ...
                                                        foreach ($result as $row) { ?>
                                                            <tr>
                                                                ...
                                                                <td data-title="<?php echo 'View'; ?>" class="numeric">
                                                                    <a href="<?php echo base_url('FlipGroup/layoutfull/' . $row->id); ?>" class="btn btn-block btn-dropbox"> View</a></td>
