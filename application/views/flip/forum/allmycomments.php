                                    ...
                                    foreach ($allmycomments as $row){?>
                                            <tr>
                                                ...
                                                <td data-title="Comments Edit" class="numeric">
                                                    <a href="<?php echo base_url('FlipForum/editComment/'.$row->comment_id);?>" type="button" class="btn btn-block btn-primary">
                                                        Edit
                                                    </a>
                                                </td>
                                                <td data-title="Comments Delete" class="numeric">
                                                    <a href="<?php echo base_url('FlipForum/forum/deleteComment/'.$row->comment_id);?>" type="button" class="btn btn-block btn-danger">
                                                        Delete
                                                    </a>
                                                </td>
                                        </tr>
