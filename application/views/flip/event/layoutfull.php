            ...
            <div class="col-md-7">
                <div class="visible-xs">
                    <div class="box box-warning">
                        <div class="box-header with-border">
                            ...
                            <span class="added-by"><b>Added By: </b><span class="added-user1 bg-primary pull-right"><a href="<?php echo base_url('flipshowProfile/'.$layoutfull['user_id']);?>"><?php echo getNameByflip($layoutfull['user_id']);?></a></span></span>
                        </div>
                    </div>
                </div>
                <div class="box box-warning">
                    <div class="box-header with-border">
                        ...
                        <span class="added-by pull-right hidden-xs"><b>Added By: </b><span class="added-user bg-primary"><a style="color: #fff;" href="<?php echo base_url('flipshowProfile/'.$layoutfull['user_id']);?>"><?php echo getNameByflip($layoutfull['user_id']);?></a></span></span>
                ...
                <div class="box box-success">
                    ...
                    <div class="box-body">
                        <div class="row">
                            <div class="col-md-6">
                                <img class="box-header with-border img-product-layout" src="<?php echo base_url() . '/assets/flip/event/' . $layoutfull['primary_photo'] ?>" width="220px;" height="180px">
                            </div>
                            <div class="col-md-6">
                                <?php if($layoutfull['photo_2'] != 0){?>
                                <img class="box-header with-border img-product-layout" src="<?php echo base_url() . '/assets/flip/event/' . $layoutfull['photo_2'] ?>" width="220px;" height="180px">
                            <?php }?>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <?php if($layoutfull['photo_3'] != 0){?>
                                    <img class="box-header with-border img-product-layout" src="<?php echo base_url() . '/assets/flip/event/' . $layoutfull['photo_3'] ?>" width="220px;" height="180px">
                                <?php }?>
                            </div>
                        </div>
                    </div>
