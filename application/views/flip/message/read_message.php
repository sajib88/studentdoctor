                ...
                <div class="box box-primary">
                    ...
                    <div class="panel">
                        <div class="panel-heading">
                            <p class="panel-title"> Subject : <?php echo $read_message['subject'];?> |  From : <?php echo getNameByflip($read_message['sender_id']);?></p>
                    ...
                    <div class="box-footer">
                        <a href="<?php echo base_url('FlipMessage/delete/'.$read_message['id']);?>" type="button" class="btn btn-default"><i class="fa fa-trash-o"></i> Delete</a>
                        <a href="<?php echo base_url('FlipMessage/reply/'.$read_message['id']);?>"> <button type="submit" class="btn btn-primary"><i class="fa fa-envelope-o"></i> Reply</button></a>
