                    ...
                    <div class="box-body box-profile">
                        <ul class="list-group list-group-unbordered">
                            ...
                            <li class="list-group-item text-center">
                                    <a class="btn btn-lg btn-danger" href="<?php echo base_url('admin/ProfileVarification/varify') .'/'. $doctorProfile['id'] . '/' . $doctorProfile['is_valid'] . '/' . $doctorProfile['user_id']; ?>">
                                    Roll Back Level 1
                                    </a>
                            </li>

                                    <li class="list-group-item text-center">
                                        <a class="btn btn-lg btn-success" href="<?php echo base_url('admin/ProfileVarification/varify_level3') . '/' . $doctorProfile['id'] . '/' . 0 . '/' .$doctorProfile['user_id']. '/' .$doctorProfile['email'] . '/' .$doctorProfile['full_name'] . '/' . $doctorProfile['npi'];?>">
                                            Direct Level 3
                                        </a>
                                    </li>
                            <?php }?>
