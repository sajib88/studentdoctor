<style>
    ...
    <div class="row">
        ...
        <form role="form" method="post" id="event" enctype="multipart/form-data" action="<?php echo base_url('FlipGroup/edit/'. $editgroup['id']); ?>">
                        ...
                        <div class="padd">
                            <div class="form-group" id="photo_id">
                                ...
                                <?php if(!empty($editgroup['primary_image'])){ ?>
                                    <a href="<?php echo base_url() . '/assets/flip/group/' .$editgroup['primary_image']; ?>" data-fancybox="images">
                                        View Picture One
                                    </a>
                                <?php }?>
                            </div>
                            <div class="form-group">
                                ...
                                <?php if(!empty($editgroup['image_2'])){ ?>
                                    <a href="<?php echo base_url() . '/assets/flip/group/' .$editgroup['image_2']; ?>" data-fancybox="images">
                                        View Picture Three
                                    </a>
                                <?php }?>
                            </div>
