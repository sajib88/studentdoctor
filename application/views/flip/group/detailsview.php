                        ...
                        <div class="box box-widget widget-user-2">
                            ...
                            <div class="widget-user-header ">
                                <div class="widget-user-image text-center">
                                    ...
                                    <img src="<?php echo base_url() . '/assets/flip/group/' .$row['primary_image']; ?>" alt="" class="group-image"  />
                            ...
                            <div class="box-footer no-padding">
                                <ul class="nav nav-stacked">
                                    <li><a href="#"><b>Group Name</b> <span class="pull-right"> <?php echo substr( $row['group_name'],0,22).'..'; ?></a></span></a></li>
                            ...
                            <div class="box-footer">
                                ...
                                <a href="<?php echo base_url('FlipGroup/layoutfull/' . $row['id']); ?>" class="btn btn-block btn-dropbox"> Discussion</a>
                            </div>
                        </div>
                    </div>
