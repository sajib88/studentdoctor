        ...
        <div class="col-lg-4">
                ...
                <div class="box-header with-border">
                  <div class="user-block">
                    ...
                    <span class="Publish Date">Added By : </b> <span><a href="<?php echo base_url('showProfile/'.$row['user_id']);?>"><?php echo getNameByflip($row['user_id']);?></a></span></span>
                  </div>
                ...
                <!-- /.box-header -->
                    ...
                    <div class="widget-user-header ">
                        <div class="widget-user-image text-center">
                            ...
                            <img src="<?php echo base_url() . 'assets/flip/blog/' .$row['primary_image']; ?>" alt="" width="100px" height="100px" class="img-size blog-image" />
                        </div>
                        </br>
                    </div>
                <div class="box-body" style="display: block;">
                  ...
                  <div class="blog-list-article">
                    ...
                    <div class="box-footer">
                        ...
                        <a href="<?php echo base_url('flipblog/details/' . $row['id']); ?>" class="btn btn-block btn-dropbox"> Read More</a>
                    </div>
                <!-- /.box-body -->
