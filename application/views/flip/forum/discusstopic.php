                            ...
                            <div class="col-lg-12 col-xs-12">
                                ...
                                <div class="small-box bg-green">
                                    <div class="inner">
                                        ...
                                        <p><?php echo $user_post_info['full_name']; ?></p>
                                    </div>
                                    <div class="icon">
                                        <i class="glyphicon glyphicon-bullhorn"></i>
                                    </div>
                                    <a href="<?php echo base_url('flipshowProfile/'.$postdeatils['author_id']);?>" class="small-box-footer">
                                  ...
                                  <div class="small-box bg-yellow">
                                      <div class="inner">
                                          <h4><?php
                                              ...
                                              $data = get_data('flip_users', array('uid' => $row->user_id));
                                              echo $data['full_name'];
                                      ...
                                      <a href="<?php echo base_url('flipshowProfile/'.$row->user_id);?>" class="small-box-footer">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form role="form" method="post" id="post" enctype="multipart/form-data"
                  action="<?php echo base_url('FlipForum/discuss/' . $getid); ?>">
