                ...
                <div class="box box-default">
                    ...
                    <div class="box-body">
                        ...
                        <div class="col-md-3 text-center">
                            <a  href="<?php echo base_url('FlipForum/board'); ?>" class="btn "><i class="fa fa-home"></i> Forum Home</a>
                        ...
                        <div class="col-md-3 text-center">
                            <a data-toggle="modal" href="<?php echo base_url('FlipForum/addCategory'); ?>" class="btn "><i class="fa fa-plus"></i> Add New Category</a>

                        </div>


                        <div class="col-md-3 text-center">
                            <a  href="<?php echo base_url('FlipForum/posts'); ?>" class="btn "><i class="fa fa-list"></i> All My Posts</a>

                        </div>


                        <div class="col-md-3 text-center">
                            <a  href="<?php echo base_url('FlipForum/comments'); ?>" class="btn"><i class="fa fa-user"></i> My Posted Comments</a>
            ...
            <?php if (is_array($postdeatils)) {
                ...
                foreach ($postdeatils as $row) {
                    ...
                    <tr>
                        ...
                        <td data-title="Topic" class="numeric" > <a class="" href="<?php echo base_url('FlipForum/discuss/' . $row->post_id); ?>">  <?php echo $row->title; ?> </a>    </td>
                        <td data-title="Author" class="numeric">
                            <?php echo getNameByflip($row->author_id); ?>
                        </td>
                        ...
                        <td data-title="Reply" class="numeric" >
                            <a class="btn  btn-primary" href="<?php echo base_url('FlipForum/discuss/' . $row->post_id); ?>">  Reply</a>

                        </td>
                        <td data-title="Reply" class="numeric" >
                            <a class="btn  btn-warning" href="<?php echo base_url('FlipForum/discuss/' . $row->post_id); ?>">  Click To View</a>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form role="form" method="post" id="post" enctype="multipart/form-data"
                      action="<?php echo base_url('FlipForum/listcat/' . $getid); ?>">
