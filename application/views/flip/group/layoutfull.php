        ...
        <div class="row">
                    ...
                    <ul class="timeline timeline-inverse">
                        ...
                        <span class="bg-red">
                          <?php echo date('m-d-Y', strtotime($layoutfull['create_date'])); ?>
                            ...
                            <span style="height: 25px; float: right; border-radius: 5px;" class="bg-blue">
                                <a style="color: #000; padding: 20px;" href="<?php echo base_url('flipshowProfile/'.$layoutfull['user_id']);?>"> <?php echo getNameByflip($layoutfull['user_id']);?></a>
                            </span>
                            </span>
                        </li>
                        <!-- /.timeline-label -->
                        ...
                        foreach ($comments as $row) {
                            ...
                            <li>
                                ...
                                <div class="timeline-item">
                                    <span class="time">
                                        <i class="fa fa-user"></i> <a style="padding-right: 10px" href="<?php echo base_url('flipshowProfile/'.$row->user_id);?>"><?php echo getNameByflip($row->user_id);?></a>
            ...
            <div class="col-md-5">
                ...
                <div class="box box-success">
                    ...
                    <div class="box-body">
                        <img src="<?php echo base_url() . '/assets/flip/group/' . $layoutfull['primary_image'] ?>" width="150" height="138"">
                        <?php if($layoutfull['image_2'] != 0){?>
                            <img src="<?php echo base_url() . '/assets/flip/group/' . $layoutfull['image_2'] ?>" width="150" height="138">
                        <?php }?>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form role="form" method="post" id="post" enctype="multipart/form-data"
                      action="<?php echo base_url('FlipGroup/layoutfull/' . $getid); ?>">
