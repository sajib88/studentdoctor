                ...
                <div class="box box-primary">
                    <div class="box-body box-profile">
                        <div style="text-align: center">
                            <img  src="<?php echo base_url() . 'assets/flip/personals/' .$layoutfull['primary_photo']; ?>" alt="User profile picture"  class="circular">
                        </div>
                        ...
                        <p class="text-muted text-center"><a  style="color: goldenrod;" href="<?php echo base_url('flipshowProfile/'.$layoutfull['uid']);?>"> &nbsp Added By <?php echo getNameByflip($layoutfull['uid']); ?></a></p>
            ...
            <div class="col-lg-8">
                ...
                <div class="box box-success">
                    ...
                    <div class="box-body">
                        ...
                        <img src="<?php echo base_url() . '/assets/flip/personals/' . $layoutfull['primary_photo'] ?>" width="130" height="130"">


                        <?php if($layoutfull['photo1'] != 0){?>
                            <img src="<?php echo base_url() . '/assets/flip/personals/' . $layoutfull['photo1'] ?>" width="130" height="130">
                        <?php }?>
                        <?php if($layoutfull['photo2'] != 0){?>
                            <img src="<?php echo base_url() . '/assets/flip/personals/' . $layoutfull['photo2'] ?>" width="130" height="130"">
                        <?php }?>
