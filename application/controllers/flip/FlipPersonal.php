...
class FlipPersonal extends CI_Controller{
    ...
    public function add(){
        ...
        if ($this->input->post()) {
            ...
            if ($this->form_validation->run() == true) {
                ...
                if (isset($_FILES["primary_photo"]["name"]) && $_FILES["primary_photo"]["name"] != '') {
                    $this->PATH = './assets/flip/personals/';
                    $photo_name = time();
                ...
                $ref_id = $this->global_model->insert('flip_personals', $save);
        ...
        $this->load->view('flip/personal/add', $data);
    ...
    public function edit($id = ''){
        ...
        $data['user_info'] = $this->global_model->get_data('flip_users', array('uid' => $loginId));
        $data['personaldata'] = $this->global_model->get_data('flip_personals', array('id' => $id));
        ...
        $this->load->view('flip/flip_header', $data);
        $this->load->view('flip/personal/editPersonal', $data);
        $this->load->view('flip/flip_footer', $data);
    ...
    public function all()
    {
       ...
       // $data['allpersonals']  	 = $this->global_model->get($table);
        ...
        $data['allpersonals'] = $this->global_model->get('flip_personals', array('uid' => $loginId));
        /*print '<pre>';
        ...
        $this->load->view('flip/flip_header', $data);
        $this->load->view('flip/personal/allPersonals_view', $data);
        $this->load->view('flip/flip_footer', $data);
    ...
    public function grid()
    {
        ...
        $this->load->view('flip/flip_header', $data);
        $this->load->view('flip/personal/personalGrid_view', $data);
        $this->load->view('flip/flip_footer', $data);
    ...
    public function detail(){
        ...
        $data['layoutfull'] = $this->global_model->get_data('flip_personals', array('id' => $id));


        $this->load->view('flip/flip_header', $data);
        $this->load->view('flip/personal/personaldetail_view', $data);
        $this->load->view('flip/flip_footer', $data);
    ...
    public function search(){
        ...
        if($this->input->post()){
            ...
            $data['result'] = $this->global_model->get_personal_search_data('flip_personals',$value,FALSE,FALSE);
        ...
        $this->load->view('flip/flip_header', $data);
        $this->load->view('flip/personal/search_view', $data);
        $this->load->view('flip/flip_footer', $data);
    ...
    {
        $id = $this->uri->segment('4');
        if ($this->global_model->delete('flip_personals', array('id' => $id))) {
            $this->session->set_flashdata('success', 'Successfully Deleted!');
            redirect('flippersonal/list');
        }
