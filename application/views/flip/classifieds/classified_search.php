            ...
            <div class="col-lg-12">
                <div class="box box-primary">
                    <div class="panel-body">
                        <div class="row">
                            <form role="form" method="post"  action="<?php echo base_url('flipclassifieds/search'); ?>">
                                <div class="col-lg-4">
                                                ...
                                                <div class="box box-widget widget-user-2">
                                                    ...
                                                    <div class="widget-user-header ">
                                                        <div class="widget-user-image text-center">
                                                            ...
                                                            if($row->photo_primary != 0) {?>
                                                                <br />
                                                                <img src="<?php echo base_url() . '/assets/flip/classified/' .$row->photo_primary; ?>" alt="" width="260px" height="180px" class="img-size" />
                                                    ...
                                                    <div class="box-footer no-border">
                                                        ...
                                                        <span class="show_button">
                                                                        <a href="<?php echo base_url() .'flipclassifieds/layoutfull/' .$row->id; ?>" class=" btn btn-block btn-success">See More</a>
                                                                    </span>
                                                    </div>
                                                </div>
                                            </div>
