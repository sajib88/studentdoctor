...
<div class="content-wrapper">
    ...
    <form role="form" method="post" id="classifiedform" enctype="multipart/form-data" action="<?php echo base_url('flipclassifieds/add'); ?>">
            ...
            <div class="col-md-12 no-padding">
                <div class="box box-primary">
                    ...
                    <div class="padd">
                        <div class="form-group">
                            <label>Name</label>
                            <input name="name" value="<?php echo $user_info['full_name']; ?>" class="form-control" readonly >
                        </div>
                        <div class="form-group">
                            <label>Email</label>
