...
<div class="content-wrapper">
    ...
    <form role="form" method="post" id="classifiedform" enctype="multipart/form-data" action="<?php echo base_url('flipclassifieds/edit/'. $editclassified['id']); ?>">
                    ...
                    <div class="col-md-12 no-padding">
                        <div class="box box-primary">
                            ...
                            <div class="padd">
                                <div class="form-group">
                                    <label>Name</label>
                                    <input name="name" value="<?php echo $user_info['full_name']; ?>" class="form-control"  >
                                </div>
                                <div class="form-group">
                                    <label>Email</label>
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group" id="photo_id">
                                        ...
                                        <a href="<?php echo base_url() . '/assets/flip/classified/' .$editclassified['photo_primary']; ?>" data-fancybox="images">
                                            View Picture One
                                        </a>
                                        <?php }?>
                                    </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <a href="<?php echo base_url() . '/assets/flip/classified/' .$editclassified['photo_2']; ?>" data-fancybox="images">
                                            View Picture Two
                                        </a>
                                        <?php }?>
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <a href="<?php echo base_url() . '/assets/flip/classified/' .$editclassified['photo_3']; ?>" data-fancybox="images">
                                            View Picture Three
                                        </a>
                                        <?php }?>
                                    </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <a href="<?php echo base_url() . '/assets/flip/classified/' .$editclassified['photo_4']; ?>" data-fancybox="images">
                                            View Picture Four
                                        </a>
                                        <?php }?>
                                    </div>
