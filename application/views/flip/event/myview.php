                    ...
                    <div class="col-sm-4">
                        <div class="panel panel-primary event-primary">
                            ...
                            <div class="panel-body nopadding">
                                <img src="<?php echo base_url() . '/assets/flip/event/' .$row->primary_photo; ?>" alt="event image" width="100%" height="30%" class="img-responsive"/>
                            ...
                            <div class="panel-footer panel-primary">
                                ...
                                <a href="<?php echo base_url('flipevent/edit/' . $row->id); ?>" class="btn btn-success">Edit</a>
                                <a href="<?php echo base_url('flipevent/layoutfull/' . $row->id); ?>" class="btn btn-warning"> View Details</a>
                                <a href="<?php echo base_url('flipevent/event/delete/' . $row->id); ?>" class="btn  btn-danger">Delete</a>
                            </div>
                        </div>
                    </div>
