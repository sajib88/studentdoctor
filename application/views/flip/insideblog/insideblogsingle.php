            ...
            <div class="col-md-4">
                ...
                <div class="box box-primary">
                    <div class="box-body box-profile">
                        <img src="<?php echo base_url() . 'assets/flip/blog/' .$single_post['primary_image'] ?>" alt="" width="220" height="140" class=" center-block" />
                        <h4 class="profile-username text-center"> <?php echo $single_post['title']; ?></h4>
                        <p class="text-center"><b>Added By : </b> <span><a href="<?php echo base_url('showProfile/'.$single_post['user_id']);?>"><?php echo getNameByflip($single_post['user_id']);?></a></span></p>
                        <br>
                ...
                <div class="box box-success">
                    ...
                    <div class="box-body">
                        ...
                        <img src="<?php echo base_url() . '/assets/flip/blog/' . $single_post['primary_image'] ?>" width="265" height="200"">


                        <?php if($single_post['image1'] != 0){?>
                            <img src="<?php echo base_url() . '/assets/flip/blog/' . $single_post['image1'] ?>" width="130" height="130">
                        <?php }?>

                        <?php if($single_post['image2'] != 0){?>
                            <img src="<?php echo base_url() . '/assets/flip/blog/' . $single_post['image2'] ?>" width="130" height="130">
                        <?php }?>
                        ...
                        <?php if($single_post['file1'] != 0){?>
                            <div class="box box-success">
                                ...
                                <div class="box-body">
                                    ...
                                    <a href="<?php echo base_url() . '/assets/flip/blog/' . $single_post['file1'];?>">Download File  </a><br/>
