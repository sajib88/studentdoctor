            ...
            <div class="col-lg-12">
                <div class="box box-primary">
                    <div class="panel-body">
                        <div class="row">
                            <form role="form" method="post"  action="<?php echo base_url('flipprofile/search'); ?>">
                                                            ...
                                                            <div class="box box-widget widget-user-2">
                                                                ...
                                                                <div class="box-footer ">
                                                                    <ul class=" list-group list-group-unbordered">
                                                                        <li class="list-group-item">Full Name <span class="pull-right  "><?php echo (!empty($row->user_name))?$row->user_name:''?></span></li>
                                                                    ...
                                                                    <span class="show_button">
                                                                        <a href="<?php echo base_url() .'flipshowProfile/' .$row->uid; ?>" class=" btn btn-block btn-success">See More</a>
                                                                    </span>
                                                                </div>
                                                            </div>
                                                        </div>
