...
class FlipEvent extends CI_Controller {
    ...
    public function index()
    {
        ...
        $loginId = $this->session->userdata('login_id');
            ...
            if ($this->input->post()) {
                ...
                if ($this->form_validation->run() == true) {
                   ...
                   // $save['ticketprice'] = $postData['ticketprice'];
                    ...
                    if ($ref_id = $this->global_model->insert('flip_event', $save)) {
            ...
            $this->load->view('flip/event/add', $data);
    ...
    public function edit()
    {
        ...
        if ($this->input->post()) {
            ...
            if ($this->form_validation->run() == true) {
                ...
                if ($this->global_model->update('flip_event', $save, array('id' => $id))){
        ...
        $data['login_id'] = $loginId = $this->session->userdata('login_id');
        $data['user_info'] = $this->global_model->get_data('flip_users', array('uid' => $loginId));

        $id = $this->uri->segment('3');
        $data['editevent'] = $this->global_model->get_data('flip_event', array('id' => $id));
        $data['profession_by_profession'] = $this->global_model->profession_by_profession();
        $data['main_cat'] = $this->global_model->get('event_main_cat');

        $this->load->view('flip/flip_header', $data);
        $this->load->view('flip/event/edit', $data);
        $this->load->view('flip/flip_footer', $data);
    ...
    public function myevent(){
        ...
        $data['myevent'] = $this->global_model->get('flip_event', array('user_id' => $loginId));
        $data['main_cat'] = $this->global_model->get('event_main_cat');



        $this->load->view('flip/flip_header', $data);
        $this->load->view('flip/event/myview', $data);
        $this->load->view('flip/flip_footer', $data);
    ...
    public function viewall(){
        ...
        $data = array();
        $data['page_title'] = 'All Event List';
        $data['tabActive'] = 'private';
        $data['error'] = '';
      ...
      // echo  $today = strtotime(date('Y-m-d', time()));
        ...
        $data['viewallevent'] = $this->global_model->getViewByProfession('flip_event', $profession, $newcomefirst);
        $data['main_cat'] = $this->global_model->get('event_main_cat');



        $this->load->view('flip/flip_header', $data);
        $this->load->view('flip/event/detailsview', $data);
        $this->load->view('flip/flip_footer', $data);
    ...
    public function layoutfull()
    {
        ...
        $data['page_title'] = 'Event Details View';
        $data['tabActive'] = 'private';
        $data['error'] = '';
        ...
        $id = $this->uri->segment('3');
        $data['layoutfull'] = $this->global_model->get_data('flip_event', array('id' => $id));
        $data['main_cat'] = $this->global_model->get('event_main_cat');



        $this->load->view('flip/flip_header', $data);
        $this->load->view('flip/event/layoutfull', $data);
        $this->load->view('flip/flip_footer', $data);
    ...
    public function search(){
        ...
        if($this->input->post()){
            ...
            $data['result'] = $this->global_model->get_event_search_data('flip_event',$value,FALSE,FALSE);
        ...
        $this->load->view('flip/flip_header', $data);
        $this->load->view('flip/event/search_view', $data);
        $this->load->view('flip/flip_footer', $data);
