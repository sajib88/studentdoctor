...
<div class="content-wrapper">
    ...
    <form role="form" method="post" id="personalsearch" name="personalsearch" enctype="multipart/form-data" action="<?php echo base_url('flippersonal/search'); ?>">
                                                            ...
                                                            <div class="col-lg-4 col-xs-12">
                                                                <div class="box box-widget widget-user-1">
                                                                    ...
                                                                    <div class="widget-user-header ">
                                                                        <div class="widget-user-image text-center">
                                                                            ...
                                                                            if($row->primary_photo != 0) {?>
                                                                                <br />
                                                                                <img src="<?php echo base_url() . '/assets/flip/personals/' .$row->primary_photo; ?>" alt="" width="220" height="200px" class="img-size" />
                                                                    ...
                                                                    <div class="box-footer no-border">
                                                                        ...
                                                                        <a href="<?php echo base_url() .'flippersonal/detail/' .$row->id; ?>" class=" btn btn-block btn-success">See Details</a>
                                                                    </span>
                                                                    </div>
                                                                </div>
                                                            </div>
