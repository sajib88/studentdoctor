                        ...
                        <div class="box box-widget widget-user-2">
                            ...
                            <div class="widget-user-header ">
                                <div class="widget-user-image text-center">
                                    ...
                                    <img src="<?php echo base_url() . 'assets/flip/personals/' .$row['primary_photo']; ?>" alt="" width="260px" height="180px" class="img-size" />
                            ...
                            <div class="box-footer no-padding">
                                <ul class="nav nav-stacked">
                                    ...
                                    <li><a class="pull-right" style="color: goldenrod;" href="<?php echo base_url('flipshowProfile/'.$row['uid']);?>"> &nbsp Added By <?php echo getNameByflip($row['uid']); ?></a></li>
                            ...
                            <div class="box-footer">
                                ...
                                <a href="<?php echo base_url() . 'flippersonal/detail/' .$row['id']; ?>" class="btn btn-block btn-success"> Details View</a>
