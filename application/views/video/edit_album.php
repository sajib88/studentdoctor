                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        <div class="col-md-12 well text-center">
                            <?php echo form_open_multipart('video/video/update');?>
                            <div class="form-group">
                                ...
                                <input type="text" name="album_name_post" value="<?php echo $v;?>" id="album" placeholder="Create Album" required class="form-control" />
                            </div>
