    ...
    <section class="content">
        <div class="row">
                    ...
                    <div class="box-body no-padding">
                        <ul class="nav nav-pills nav-stacked">
                            ...
                            <li class="<?php if($this->uri->segment(2)=='message'){echo 'active';}?>"><a href="<?php echo base_url('message');?>"><i class="fa fa-inbox"></i> Inbox
                                    <span class="label label-primary pull-right"></span></a></li>
                            <li class="<?php if($this->uri->segment(2)=='sentMessages' && $this->uri->segment(2)=='sentMessages'){echo 'active';}?>"><a href="<?php echo base_url('message/sentMessages');?>"><i class="fa fa-envelope-o"></i> Sent</a></li>
                        </ul>
                    </div>
                    <!-- /.box-body -->
                </div>
            ...
            <div class="col-md-9">
                ...
                <form role="form" method="post" id="message_form" enctype="multipart/form-data" action="<?php echo base_url('message/reply/'.$read_message['id']); ?>">
