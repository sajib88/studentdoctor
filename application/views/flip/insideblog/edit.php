...
<div class="content-wrapper" id="page-wrapper">
    ...
    <section class="content">
        ...
        <?php } ?>
            <form role="form" method="post" id="blogform" enctype="multipart/form-data" action="<?php echo base_url('flipblog/edit/'. $editblog['id']); ?>">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group" id="photo_id">
                                        ...
                                        <?php if(!empty($editblog['primary_image'])){ ?>
                                            <a href="<?php echo base_url() . 'assets/flip/blog/' .$editblog['primary_image']; ?>" data-fancybox="images">
                                                View Picture One
                                            </a>
                                        <?php }?>
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <?php if(!empty($editblog['image1'])){ ?>
                                            <a href="<?php echo base_url() . 'assets/flip/blog/' .$editblog['image1']; ?>" data-fancybox="images">
                                                View Picture Two
                                            </a>
                                        <?php }?>
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <?php if(!empty($editblog['image2'])){ ?>
                                            <a href="<?php echo base_url() . 'assets/flip/blog/' .$editblog['image2']; ?>" data-fancybox="images">
                                                View Picture Three
                                            </a>
                                        <?php }?>
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <?php if(!empty($editblog['image3'])){ ?>
                                            <a href="<?php echo base_url() . 'assets/flip/blog/' .$editblog['image3']; ?>" data-fancybox="images">
                                                View Picture Four
                                            </a>
                                        <?php }?>
                                    </div>
