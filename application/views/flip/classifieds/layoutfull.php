        ...
        <div class="row">
            ...
            <div class="col-md-9">
                    <div class="slider">
                        <div data-index="1">
                            <?php if(!empty($layoutfull['photo_primary'])){ ?>
                                <img src="<?php echo base_url() . '/assets/flip/classified/' . $layoutfull['photo_primary'] ?>" width="100%" class="img-responsive" alt="One">
                            <?php }else{} ?>
                        </div>
                        <div data-index="2">
                            <?php if(!empty($layoutfull['photo_2'])){ ?>
                                <img src="<?php echo base_url() . '/assets/flip/classified/' . $layoutfull['photo_2'] ?>" width="100%" class="img-responsive" alt="One">
                            <?php }else{} ?>
                        </div>
                        <div data-index="3">
                            <?php if(!empty($layoutfull['photo_3'])){ ?>
                                <img src="<?php echo base_url() . '/assets/flip/classified/' . $layoutfull['photo_3'] ?>" width="100%" class="img-responsive" alt="One">
                            <?php }else{} ?>
                        </div>
                        <div data-index="4">
                            <?php if(!empty($layoutfull['photo_4'])){ ?>
                                <img src="<?php echo base_url() . '/assets/flip/classified/' . $layoutfull['photo_4'] ?>" width="100%" class="img-responsive" alt="One">
                            <?php }else{} ?>
                        </div>
                    </div>
                    ...
                    <div class="slider-nav-thumbnails">
                        <div class="item">
                            <?php if(!empty($layoutfull['photo_primary'])){ ?>
                                <img src="<?php echo base_url() . '/assets/flip/classified/' . $layoutfull['photo_primary'] ?>" class="img-responsive" slide="slide_1">
                            <?php }else{} ?>
                        </div>
                        <div class="item">
                            <?php if(!empty($layoutfull['photo_2'])){ ?>
                                <img src="<?php echo base_url() . '/assets/flip/classified/' . $layoutfull['photo_2'] ?>" class="img-responsive" slide="slide_2">
                            <?php }else{} ?>
                        </div>
                        <div class="item">
                            <?php if(!empty($layoutfull['photo_3'])){ ?>
                                <img src="<?php echo base_url() . '/assets/flip/classified/' . $layoutfull['photo_3'] ?>" class="img-responsive" slide="slide_3">
                            <?php }else{} ?>
                        </div>
                        <div class="item">
                            <?php if(!empty($layoutfull['photo_4'])){ ?>
                                <img src="<?php echo base_url() . '/assets/flip/classified/' . $layoutfull['photo_4'] ?>" class="img-responsive" slide="slide_4">
                            <?php }else{} ?>
                        </div>
                    </div>
                            ...
                            <?php if(!empty($layoutfull['primary_video']) or !empty($layoutfull['primary_sound']) or !empty($layoutfull['primary_file'])) { ?>
                                ...
                                <?php if ($layoutfull['primary_sound'] != 0) { ?>
                                    <div class="box box-success">
                                        ...
                                        <div class="box-body">
                                            <audio src="<?php echo base_url() . '/assets/flip/classified/' . $layoutfull['primary_sound']; ?>"
                                                   preload="auto"/>
                                        </div>
                                    </div>
                                <?php }
                                ...
                                <?php if ($layoutfull['primary_file'] != 0) { ?>
                                    <div class="box box-success">
                                        ...
                                        <div class="box-body">
                                            <a href="<?php echo base_url() . '/assets/flip/classified/' . $layoutfull['primary_file']; ?>">Download
                                                File </a><br/>
                                        </div>
                                    </div>
                                <?php }
            ...
            <div class="col-md-3">
                ...
                <div class="price-tag">
                    ...
                    <p class="pdl"><a class="btn btn-warning btn-md" style="color: #fff;" href="<?php echo base_url('flipshowProfile/'.$layoutfull['user_id']);?>"><?php echo getNameByflip($layoutfull['user_id']); ?></a></p>
                </div>
                <hr>
            </div>
