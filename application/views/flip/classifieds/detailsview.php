        ...
        <div class="box box-widget widget-user-2">
            ...
            <div class="widget-user-header ">
                <div class="widget-user-image text-center">
                    ...
                    <img src="<?php echo base_url() . '/assets/flip/classified/' .$row['photo_primary']; ?>" alt="" width="270px" height="180px" class="img-size" />
            ...
            <div class="box-footer">
                ...
                <a href="<?php echo base_url('flipclassifieds/layoutfull/' . $row['id']); ?>" class="btn btn-block btn-success"> Details View</a>
