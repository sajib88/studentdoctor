...
<nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
    <div class="navbar-header">
        ...
        <a class="navbar-brand" href="#">Secure Admin Panel</a>
    ...
    <div class="navbar-default sidebar" role="navigation">
        <div class="sidebar-nav navbar-collapse">
            <ul class="nav" id="side-menu">
                ...
                <li>
                    <a href="<?php echo base_url('admin/dashboard'); ?>"><i class="fa fa-dashboard fa-fw"></i> Admin Dashboard</a>
                </li>
                <li>
                    <a href="<?php echo base_url('admin/ProfileVarification'); ?>">
                        <i class="fa fa-fw fa-user"></i> Doctor Verification  Level Set</a>
                </li>
                <!--<li>
                    <a href="<?php /*echo base_url('admin/DoctorVarification'); */?>">
                        <i class="fa fa-fw fa-user-md"></i> Level (3) Doctor Verification </a>
                </li>-->


                <?php if($type == 1 ) {?>
                <li>
                    <a href="<?php echo base_url('admin/users'); ?>"><i class="fa fa-table fa-fw"></i> Website Users</a>
                </li>
...
<!--                </li>-->
                ...
                <li>
                    ...
                    <li>
                        <a href="<?php echo base_url('admin/AdminUsers'); ?>"><i class="fa fa-table fa-fw"></i> Admin Users</a>
                    </li>
